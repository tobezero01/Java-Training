package com.redis.demo.redis.entity;
...
@Table(
        ...
        indexes = {
                ...
                // truy vấn enabled/top-level/breadcrumb
                @Index(name = "idx_category_enabled_parent", columnList = "enabled, parent_id"),
                @Index(name = "idx_category_all_parents", columnList = "all_parent_ids")
        }
)
